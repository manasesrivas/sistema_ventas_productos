                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <?php if ($descuento['estado'] === 'activa'): ?>
                                    <a href="index.php?accion=desactivar&id=<?php echo mostrarValor($descuento['id_descuento']); ?>"
                                       class="btn btn-danger btn-sm"
                                       onclick="return confirm('¿Desactivar este descuento?');">
                                        Desactivar
                                    </a>
                                <?php else: ?>
                                    <a href="index.php?accion=activar&id=<?php echo mostrarValor($descuento['id_descuento']); ?>"
